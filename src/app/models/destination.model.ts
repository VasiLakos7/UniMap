...
export const destinationList: Destination[] = [
  // 1️⃣ Τμήμα Μαιευτικής
  {
    ...
    // 👉 ΝΕΑ ΕΙΣΟΔΟΣ
    entranceLat: 40.657129383535285,
    entranceLng: 22.805900015164596,
  ...
  // 2️⃣ Τμήμα Νοσηλευτικής
  {
    ...
    // 👉 ΝΕΑ ΕΙΣΟΔΟΣ
    entranceLat: 40.657403177714485,
    entranceLng: 22.804956696585524,
    image: 'assets/images/dipae_logo.png',
  ...
  // 3️⃣ Τμήμα Φυσικοθεραπείας
  {
    ...
    // 👉 ΝΕΑ ΕΙΣΟΔΟΣ (πολύ κοντά στην προηγούμενη, αλλά updated)
    entranceLat: 40.65741108499712,
    entranceLng: 22.80423227005972,
    image: 'assets/images/dipae_logo.png',
