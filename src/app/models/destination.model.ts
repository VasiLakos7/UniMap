...
export const destinationList: Destination[] = [
  ...
  // 2️⃣ Τμήμα Νοσηλευτικής
  {
    ...
    entranceLat: 40.65743829148304,
    entranceLng: 22.804971822529954,
    ...
    // 5️⃣ Τμήμα Γεωπονίας
  {
    ...
    lat: 40.6582175,
    lng: 22.8037,
    entranceLat: 40.65855238507725,
    entranceLng: 22.80363724466494,
  ...
  // 🔟 Τμήμα Διοίκησης Οργανισμών, Μάρκετινγκ και Τουρισμού
  {
    ...
    entranceLat: 40.6571873501526,
    entranceLng: 22.80376206408176,
